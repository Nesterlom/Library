...
public class BookController {
    ...
    public List<Book> find(@RequestParam(value = "findBy") FindBy method,
        ...
        return service.findBook(method, param);
    }
    ...
    @Transactional
    @PostMapping("/insert/{bookName}/{year}")
    public void addBook(@PathVariable String bookName, @PathVariable int year){
        bookRepo.addBook(bookName, year);
    }
